// Lay the topographical map on top of the HTML:
let topographMap = L.tileLayer(
...
// Create the map object and add the topographical details
...
topographMap.addTo(earthquakeMap);
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (earthquakeData) {
  ...
  // Use range of depth to determine shade of circle
